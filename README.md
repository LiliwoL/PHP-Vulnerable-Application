...
Le but de cette application est de montrer des vulnérabilités courantes dans les applications PHP.

Les dépendances sont chargées automatiquement.
Les données sont chargées en base.
